...
import { GET_UNITS } from '../symbols/units';
import {
  getUnitsActionSuccess,
  getUnitsActionFailure,
} from '../actions/units/get';
 ...
 */
function* watcher() {
  yield takeLatest(GET_UNITS, function* ({ payload }: any) {
    let response;
    try {
      response = units;
    } catch (e) {
      yield put(getUnitsActionFailure(e));
      return 0;
    }
    yield put(getUnitsActionSuccess(response));
  });
}
